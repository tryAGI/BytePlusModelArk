<div class="docs-hero">
  <h1>BytePlusModelArk</h1>
  <p class="docs-hero-lead">Modern .NET SDK for BytePlusModelArk generated from the provider's OpenAPI definition with AutoSDK.</p>
  <div class="docs-badge-row">
    <a href="https://www.nuget.org/packages/BytePlusModelArk/"><img alt="Nuget package" src="https://img.shields.io/nuget/vpre/BytePlusModelArk"></a>
    <a href="https://github.com/tryAGI/BytePlusModelArk/actions/workflows/dotnet.yml"><img alt="dotnet" src="https://github.com/tryAGI/BytePlusModelArk/actions/workflows/dotnet.yml/badge.svg?branch=main"></a>
    <a href="https://github.com/tryAGI/BytePlusModelArk/blob/main/LICENSE.txt"><img alt="License: MIT" src="https://img.shields.io/github/license/tryAGI/BytePlusModelArk"></a>
...
<div class="docs-feature-grid">
  <div class="docs-feature-card">
    ...
    <p>Built from <a href="src/libs/BytePlusModelArk/openapi.yaml">BytePlus ModelArk's OpenAPI definition</a> so the SDK stays close to the upstream API surface.</p>
  </div>
  <div class="docs-feature-card">
    <h3>Auto-updated</h3>
...
<div class="docs-card-grid">
  <div class="docs-card">
    <h3>Bugs</h3>
    <p>Open an issue in <a href="https://github.com/tryAGI/BytePlusModelArk/issues">tryAGI/BytePlusModelArk</a>.</p>
  </div>
  <div class="docs-card">
    <h3>Ideas and questions</h3>
    <p>Use <a href="https://github.com/tryAGI/BytePlusModelArk/discussions">GitHub Discussions</a> for design questions and usage help.</p>
  </div>
  <div class="docs-card">
    <h3>Community</h3>
