...
internal static class CliRuntime
{
    ...
    public static async Task<global::BytePlusModelArk.BytePlusModelArkClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::BytePlusModelArk.ApiException exception)
    {
        var builder = new StringBuilder();
