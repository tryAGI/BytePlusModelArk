...
namespace BytePlusModelArk.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "BytePlusModelArk.CLI";
    private const string UserSecretApiKeyName = "BYTEPLUSMODELARK_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BYTEPLUSMODELARK_API_KEY"];
    private const string CredentialFileDirectoryName = ".byte-plus-model-ark";

    public static async global::System.Threading.Tasks.Task<global::BytePlusModelArk.BytePlusModelArkClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::BytePlusModelArk.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::BytePlusModelArk.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::BytePlusModelArk.BytePlusModelArkClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::BytePlusModelArk.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::BytePlusModelArk.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::BytePlusModelArk.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::BytePlusModelArk.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BYTEPLUSMODELARK_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::BytePlusModelArk.ApiException exception)
    {
        var builder = new StringBuilder();
